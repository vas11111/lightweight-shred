...
impl ProcessShredsStats {
    pub fn submit(
        ...
        _name: &'static str,
        _slot: Slot,
        _slot_broadcast_time: Option<Duration>,
    ) {
        // Metrics submission removed in vendored version.
        *self = Self::default();
    }
...
impl ShredFetchStats {
    pub fn maybe_submit(&mut self, _name: &'static str, cadence: Duration) -> bool {
